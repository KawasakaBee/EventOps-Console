...
const getAssignErrorState = (
  ...
  switch (error.code) {
    ...
    case 'REVIEWER_NOT_FOUND':
      return {
        type: 'state',
        title: 'Ревьюер не найден',
        subtitle:
          'Убедитесь в правильном выборе ревьюера и попробуйте отправить запрос снова.',
        fullHeight: true,
        action: {
          handler: actions.retry,
          buttonName: 'Повторить',
...
export default getAssignErrorState;
