...
export const initialReviews = [
...

  {
    ...
    scoreDelivery: 9,
    comment:
      'Очень сильный практический воркшоп: есть понятные артефакты, зрелые trade-offs и хорошая связь с API governance.',
    recommendation: 'approve',
  },
  {
    id: 'review-078',
    ...
    scoreDelivery: 8,
    comment:
      'Тема зрелая и хорошо подходит DevOps & Cloud треку. Рекомендую принять с сохранением блока про postmortem.',
    recommendation: 'approve',
  },
  {
    id: 'review-079',
    ...
    scoreDelivery: 8,
    comment:
      'Хороший lightning talk: компактный, прикладной и без лишней теории. Подойдёт как короткий слот между большими докладами.',
    recommendation: 'approve',
  },
  {
    id: 'review-080',
    ...
    scoreDelivery: 7,
    comment:
      'Тема важная, но в 30 минут может не поместиться. Нужен более чёткий фокус на internal tools и RBAC.',
    recommendation: 'request_changes',
  },
  {
    id: 'review-081',
    ...
    scoreDelivery: 6,
    comment:
      'Рекомендую запросить изменения: нужно сузить материал и добавить один конкретный production-кейс.',
    recommendation: 'request_changes',
  },
  {
    id: 'review-082',
    ...
    scoreDelivery: 5,
    comment:
      'Сейчас заявка выглядит как обзор AI-инструментов без достаточного production-кейса. Для программы слабовато.',
    recommendation: 'reject',
  },
  {
    id: 'review-083',
    ...
    scoreDelivery: 9,
    comment:
      'Отличный воркшоп для Product Analytics события: есть упражнение, метрики и практический результат.',
    recommendation: 'approve',
  },
  {
    id: 'review-084',
    ...
    scoreDelivery: 9,
    comment:
      'Сильный доклад про визуализацию: хорошо связан с KPI cards, dashboard и управленческими решениями.',
    recommendation: 'approve',
  },
  {
    id: 'review-085',
    ...
    scoreDelivery: 8,
    comment:
      'Зрелая заявка для frontend/product стыка. Рекомендую принять, если найдётся место в сетке.',
    recommendation: 'approve',
  },
  {
    id: 'review-086',
    ...
    scoreDelivery: 7,
    comment:
      'Идея полезная, но длительность 120 минут требует более конкретного плана упражнений и результата.',
    recommendation: 'request_changes',
  },
  {
    id: 'review-087',
    ...
    scoreDelivery: 6,
    comment:
      'Тема пересекается с уже принятыми материалами по тестированию, а новый угол пока выражен слабо.',
    recommendation: 'reject',
  },
  {
    id: 'review-088',
    ...
    scoreDelivery: 9,
    comment:
      'Очень сильная заявка: data contracts, ownership и production-подход хорошо раскрывают тему AI DataOps.',
    recommendation: 'approve',
  },
  {
    id: 'review-089',
    ...
    scoreDelivery: 9,
    comment:
      'Сильная тема на стыке UX и AI. Рекомендую принять и поставить рядом с AI/Data блоком.',
    recommendation: 'approve',
  },
  {
    id: 'review-090',
    ...
    scoreDelivery: 8,
    comment:
      'Практичная заявка про интеграцию LLM в legacy backend. Особенно полезен блок про anti-corruption layer.',
    recommendation: 'approve',
  },
  {
    id: 'review-091',
    ...
    scoreDelivery: 8,
    comment:
      'Воркшоп сильный, но требует длинного слота и подготовленной аудитории. Рекомендую принять в резерв.',
    recommendation: 'approve',
  },
  {
    id: 'review-092',
    ...
    scoreDelivery: 7,
    comment:
      'Идея хорошая, но нужен один конкретный пример и более жёсткие критерии stop/go.',
    recommendation: 'request_changes',
  },
] satisfies Review[];
