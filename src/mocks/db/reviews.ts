...
export const initialReviews = [
  {
    ...
    scoreRelevance: 10,
    scoreDelivery: 9,
    comment: "Хороший баланс технических деталей и продуктового контекста. Рекомендую принять в программу.",
  ...
  },
  {
    ...
    scoreRelevance: 2,
    scoreDelivery: 4,
    comment: "Тема потенциально интересная, но сейчас заявка слишком общая и не показывает достаточной практической ценности.",
  ...
  },
  {
    ...
    scoreRelevance: 10,
    scoreDelivery: 8,
    comment: "Тема выглядит зрелой для программы. Есть конкретный кейс, понятная структура и ожидаемая польза для аудитории.",
    recommendation: "approve",
  },
  {
    id: "review-004",
    ...
    scoreRelevance: 6,
    scoreDelivery: 6,
    comment: "Рекомендую запросить изменения: тема подходит, но описание пока не даёт достаточно уверенности в качестве выступления.",
  ...
  },
  {
    ...
    scoreRelevance: 8,
    scoreDelivery: 7,
    comment: "Сильная заявка: понятный problem statement, есть практические выводы и хорошая связь с темой трека.",
    recommendation: "approve",
  },
  {
    id: "review-006",
  ...
  },
  {
    ...
    scoreRelevance: 7,
    scoreDelivery: 7,
    comment: "Нужно уточнить структуру доклада, добавить практические примеры и явно описать, что слушатель сможет применить после выступления.",
    recommendation: "request_changes",
  },
  {
    id: "review-010",
  ...
  },
  {
    ...
    scoreRelevance: 4,
    scoreDelivery: 4,
    comment: "Заявка выглядит слабее остальных по треку. Рекомендую отклонить или полностью переработать под следующий CFP.",
    recommendation: "reject",
  },
  {
    id: "review-023",
  ...
  },
  {
    ...
    scoreRelevance: 6,
    scoreDelivery: 7,
    comment: "Есть хороший потенциал, но требуется доработать abstract и сузить фокус, чтобы заявка не выглядела слишком широкой.",
    recommendation: "request_changes",
  },
  {
    id: "review-029",
  ...
  },
  {
    ...
    scoreRelevance: 2,
    scoreDelivery: 5,
    comment: "Не хватает конкретики: нет чёткого кейса, критериев успеха и понятного результата для слушателей.",
    recommendation: "reject",
  },
  {
    id: "review-031",
...
export const initialReviewers = [
  ...
  },
  {
    ...
    proposalIds: ["proposal-028", "proposal-034", "proposal-038", "proposal-068", "proposal-088", "proposal-097"],
