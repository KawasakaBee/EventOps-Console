...
export const initialComments = [
  {
    ...
    actorId: "2",
    actorRole: "manager",
    message: "После ревью можно будет принять решение по статусу без дополнительного созвона.",
  ...
  },
  {
    ...
    actorRole: "reviewer",
    message: "Содержание выглядит перспективно, но нужна более чёткая структура.",
  ...
  },
  {
    ...
    actorId: "manager-002",
    actorRole: "manager",
    message: "Заявка подходит по теме трека, но нужно проверить глубину материала.",
  ...
  },
  {
    ...
    actorId: "manager-002",
    actorRole: "manager",
    message: "Есть риск пересечения с похожими докладами, нужна дополнительная оценка.",
  ...
  },
  {
    ...
    actorRole: "reviewer",
    message: "Нужно уточнить целевую аудиторию и ожидаемый уровень подготовки слушателей.",
  ...
  },
  {
    ...
    actorId: "manager-003",
    actorRole: "manager",
    message: "Попросил ревьюера обратить внимание на практическую применимость доклада.",
